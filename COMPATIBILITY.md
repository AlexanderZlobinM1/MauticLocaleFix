...
Supported Mautic range remains 6.x, 7.x.
...
Fresh-kernel service instantiation and form construction/resolution passed on `7.2.0`, `7.1.3`, `6.0.9`. Mautic 5/6 used PHP 8.2.33; Mautic 7 used PHP 8.4.25. External delivery and OAuth/CAPTCHA provider exchanges were not exercised.

Google image-proxy handling remains enabled only for Mautic 7 when the existing switch is on. The Mautic 6 disabled path and calendar/search behavior remain covered by regression tests.
